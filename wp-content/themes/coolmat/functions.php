...
function coolmat_scripts() {
	// wp-enqueue_style looks for a default style.css in our theme directory
	wp_enqueue_style( 'coolmat-style', get_stylesheet_uri(), array(), _S_VERSION );
	
	// here we load out custom.css file using wp_enqueue_style
...
// here we add out loaction custom post type
